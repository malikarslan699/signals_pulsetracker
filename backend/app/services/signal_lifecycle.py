...
# Canonical-only SQL sets for stats/analytics (no legacy values).
CANONICAL_OPEN_STATUS_SQL = "('CREATED','ARMED','FILLED','TP1_REACHED')"
CANONICAL_PARTIAL_WIN_STATUS_SQL = "('TP1_REACHED')"
CANONICAL_WIN_STATUS_SQL = "('TP2_REACHED')"
CANONICAL_LOSS_STATUS_SQL = "('STOPPED')"
CANONICAL_STALE_STATUS_SQL = "('EXPIRED','INVALIDATED')"
CANONICAL_FINAL_STATUS_SQL = "('TP2_REACHED','STOPPED','EXPIRED','INVALIDATED')"
CANONICAL_POSITIVE_PROGRESS_STATUS_SQL = "('TP1_REACHED','TP2_REACHED')"
